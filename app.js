document.getElementById("submit").addEventListener("click", function () {
    ...
    let subtotalmath = firstPrizeChange + secondPrizeChange + thirdPrizeChange + fourthPrizeChage + fivePrizeChange + sixPrizeChange + sevenPrizeChange + eightPrizeChange + ninePrizeChange + tenPrizeChange + eleventPrizeChange + twolvePrizeChange + thirteenPrizeChange;
